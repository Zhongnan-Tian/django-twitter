...
class NewsFeedApiTests(TestCase):
    ...
    def test_list(self):
        ...
        # can see the tweet created by yourself
        self.user1_client.post(POST_TWEETS_URL, {'content': 'Hello World'})
        response = self.user1_client.get(NEWSFEEDS_URL)
        self.assertEqual(len(response.data['results']), 1)

        # follow others and see theirs tweets in newsfeed
    ...
    def test_user_cache(self):
        ...
        self.assertEqual(results[0]['tweet']['user']['nickname'], 'newname')
        ...
        results = response.data['results']
        self.assertEqual(results[0]['tweet']['user']['username'], 'user2')
        self.assertEqual(results[0]['tweet']['user']['nickname'], 'profilenickname')
        self.assertEqual(results[1]['tweet']['user']['username'], 'user1newname')
