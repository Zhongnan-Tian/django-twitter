...
class Like(models.Model):
    ...
    class Meta:
        # this unique_together builds index <user, content_type, object_id>
        # which can help to query what objects a specific user liked.
        # <content_type, object_id, user> cannot.
